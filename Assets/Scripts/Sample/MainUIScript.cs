...
public class MainUIScript : MonoBehaviour
{
    ...
    public static string inapp_p5000 = "jewel_1";
    public static string inapp_p10000 = "jewel_2";
    public static string inapp_p50000 = "jewel_3";
    public static string auto_a100000 = "jewel_4";

    public static string[] inapp_products = { inapp_p5000, inapp_p10000, inapp_p50000, auto_a100000 };
    public static string[] all_products = { inapp_p5000, inapp_p10000, inapp_p50000, auto_a100000 };

    private string base64EncodedPublicKey = "enter your key";
